...
/*		SET PORT VALUE												*/
void	GPIO_voidSetPortValue(GPIO_u8_PortType Copy_PortType,GPIO_u8_VoltageType Copy_VoltageType)
{
	/*		Range Check							*/
	if(Copy_PortType < GPIO_TOTAL_PORT)
	{
		...
		case GPIO_PORTA:
			...
			switch(Copy_VoltageType)
			{
			case GPIO_HIGH   :	GPIOA_BSR=0x0000FFFF;	break;
			case GPIO_LOW	 :	GPIOA_BRR=0x0000FFFF;	break;
			default:;	/*		Return ERROR		*/
			}
			break;
		case GPIO_PORTB:
			...
			switch(Copy_VoltageType)
			{
			case GPIO_HIGH   :	GPIOB_BSR=0x0000FFFF;	break;
			case GPIO_LOW    :	GPIOB_BRR=0x0000FFFF;	break;
			default:;	/*		Return ERROR		*/
			}
			break;
		case GPIO_PORTC:
			...
			switch(Copy_VoltageType)
			{
			case GPIO_HIGH   :	GPIOC_BSR=0x0000FFFF;	break;
		    case GPIO_LOW	 :	GPIOC_BRR=0x0000FFFF;	break;
			default:;	/*		Return ERROR		*/
			}
			break;
		}
